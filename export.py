...
buildings_sql = 'SELECT id as building_id, parcel_id, development_type_id as building_type_id, residential_units, non_residential_sqft, 0 as non_residential_rent_per_sqft, year_built FROM urbansim.buildings'
